...
- Output crossover 0x31/0x32 pings are skipped by default because a bypass-form write can update remembered slope bytes even when the audible active mode remains bypassed.
...
- Baseline: `.\out\fir\fir408-peq-pings-v2\baseline`
- After: `.\out\fir\fir408-peq-pings-v2\after`
